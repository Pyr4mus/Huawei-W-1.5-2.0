...
if [ -e $INITRAMFS/negalite_kernel_HW_$REVISION.zip ]; then
	echo " "
	echo "**************************************************************"
	echo "**************************************************************"
	echo "      Pushing negalite_kernel_HW_$REVISION.zip To Watch      "
	echo "**************************************************************"
	echo "**************************************************************"
	echo " "

	adb push $INITRAMFS/negalite_kernel_HW_$REVISION.zip /sdcard/
